...
function solve(solver::DeepCrossentropyPolicySolver, pomdp::MDP; verbose = true)
    ...
    for i=1:solver.epochs
        ...
        for j=1:solver.n_samples
            ...
            session_states, session_actions, session_reward, session_states_new, session_rewards = run_experiment(pomdp, policy; max_frame_iterations = solver.max_frame_iterations, keep_history = true)
